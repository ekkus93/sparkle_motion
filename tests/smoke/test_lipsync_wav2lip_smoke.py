...
from sparkle_motion.function_tools.lipsync_wav2lip.entrypoint import make_app


def test_lipsync_wav2lip_smoke(monkeypatch, tmp_path):
    ...
    with TestClient(app) as client:
        ...
        payload = {"prompt": "smoke test lipsync"}
